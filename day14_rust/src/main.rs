...
fn fall_1(mut cave: HashSet<(i32,i32)>, start: (i32, i32), max_y: i32) -> (HashSet<(i32,i32)>, bool) {
...
fn fall_2(mut cave: HashSet<(i32,i32)>, start: (i32, i32), max_y: i32) -> (HashSet<(i32,i32)>, bool) {
    // decides where next unit of sand falls
    // check below, check left, check right, if all blocked stop
    let mut pos = start;
    loop {
